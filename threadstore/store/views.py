...
from store.models import Product,Size,Basket,BasketItems,order
...
class AddToCartView(View):
    def post(self,request,*args, **kwargs):
        ...
        #basket item_obj
        basket_item_obj=BasketItems.objects.filter(basket_object=basket_obj,product_object=product_obj,size_object=size_obj,is_order_placed=False)
