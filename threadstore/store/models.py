...
class Product(models.Model):
    ...
    image=models.ImageField(upload_to="product_images",null=True,default="product_images/default.jpg")
...
class order(models.Model):
    ...
    basket_item_objects=models.ManyToManyField(BasketItems)
    ...
    payment_mode=models.CharField(max_length=200,choices=payment_options,default="cod")
